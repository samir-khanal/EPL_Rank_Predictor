...
x_pts_only = df[['Pts','GF','GA','GD']]  # Features for Points as main factor
...
model_clf = RandomForestClassifier(random_state=42,)#class_weight='balanced'
...
joblib.dump(model_clf, 'random_forest_classifier.pkl')
